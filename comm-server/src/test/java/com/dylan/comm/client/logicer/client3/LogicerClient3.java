package com.dylan.comm.client.logicer.client3;
 ...
 */
public class LogicerClient3 {

    private static final MyLogger logger = MyLoggerFactory.getLogger(LogicerClient3.class);
